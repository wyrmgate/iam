...
-- Tighten same-tenant references into same-semantic-tuple references.
...
COMMENT ON CONSTRAINT identity_canonical_attribute_state_candidate_tuple_fk
    ...
    'Selected candidate, when present, must belong to the same Identity and canonical definition version as the resolved state.';
